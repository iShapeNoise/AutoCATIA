...
from application.pycatia_scripts.drawing.save_drawing import save_as_dxf
from application.pycatia_scripts.drawing.save_drawing import save_as_pdf


@app.route(f'{htmx}/drawing/save_as_pdf', methods=['POST'])
